        ...
        if st.button('RUN SEARCH', type="primary"):
            ...
            if comparison_mode:
                ...
                if len(model_names) < 2:
                    ...
                    model1 = st.selectbox("Select first model", model_names, key="model1", default=None)
                    remaining_models = [m for m in model_names if m != model1]
                    model2 = st.selectbox("Select second model", remaining_models, key="model2", default=None)
