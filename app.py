...
from utils import (display_distribution_charts, populate_default_values, project_indexes,
                   ...
                   get_prefixed_fields, set_state_defaults, init_llm_params, load_config, load_es_config,
    ...
    if must_term:
        ...
        if st.button('RUN SEARCH', type="primary"):
            ...
            if comparison_mode:
                ...
                # Use the primary prompt for both models in comparison mode
                primary_prompt = config['tasks'][selected_task]['primary']
                ...
                if len(model_names) < 2:
                    ...
                    with col1:
                        ...
                        content1, run_id1 = generate_output_stream(primary_prompt, llm_models[model1],
                    ...
                    with col2:
                        ...
                        content2, run_id2 = generate_output_stream(primary_prompt, llm_models[model2],
